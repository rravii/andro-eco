...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType){
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                layoutParams.setMargins(setDp(16,viewGroup.getContext()),// for left side margin
                        setDp(16,viewGroup.getContext()), // for top side margin
                        setDp(16,viewGroup.getContext()), // for right side margin
                        setDp(8,viewGroup.getContext())); // for bottom side margin
    ...
    private int setDp(int dp, Context context){ // converter from px to dp
