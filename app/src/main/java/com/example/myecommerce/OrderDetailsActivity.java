...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (model.getOrderStatus()){
            ...
            case "Ordered":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successBlue)));
            ...
            case "Cancelled":
                ...
                if (model.getPackedDate().after(model.getOrderedDate())){
                    ...
                    if (model.getShippedDate().after(model.getPackedDate())){
                        ...
                        deliveredIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.errorColor)));
                        ...
                        shippedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.errorColor)));
                    ...
                    packedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.errorColor)));
